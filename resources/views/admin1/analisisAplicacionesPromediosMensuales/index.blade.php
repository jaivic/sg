...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>updated at</th>
                            ...
                            @foreach($analisisAplicacionesPromediosMensuales as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->month !!}</td>
    <td>{!!  $row->year !!}</td>
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['analisisaplicacionespromediosmensuales.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('analisisaplicacionespromediosmensuales.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('analisisaplicacionespromediosmensuales.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
