...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['mailinglists.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('mailinglists.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('mailinglists.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
