...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>orden</th>
                            ...
                            @foreach($scheduleBackupDatabases as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->schedule_backup_id !!}</td>
    <td>{!!  $row->name !!}</td>
    ...
    <td>{!!  $row->orden !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['schedulebackupdatabases.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('schedulebackupdatabases.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('schedulebackupdatabases.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
