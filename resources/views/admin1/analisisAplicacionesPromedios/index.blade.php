...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>updated at</th>
                            ...
                            @foreach($analisisAplicacionesPromedios as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->total_aplicaciones !!}</td>
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['analisisaplicacionespromedios.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('analisisaplicacionespromedios.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('analisisaplicacionespromedios.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
