...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>ticket id</th>
                            ...
                            @foreach($fileConfigCatalogTicket as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->file_config_catalog_id !!}</td>
    <td>{!!  $row->ticket_id !!}</td>
    
                                    <td>   
                                        {!! Form::open(['route' => ['fileconfigcatalogticket.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('fileconfigcatalogticket.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('fileconfigcatalogticket.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
