...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->slack_user_id !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['users.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('users.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('users.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
