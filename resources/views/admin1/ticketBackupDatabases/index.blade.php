...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>updated at</th>
                            ...
                            @foreach($ticketBackupDatabases as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->ticket_id !!}</td>
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['ticketbackupdatabases.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('ticketbackupdatabases.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('ticketbackupdatabases.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
