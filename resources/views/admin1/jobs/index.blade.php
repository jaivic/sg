...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->created_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['jobs.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('jobs.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('jobs.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
