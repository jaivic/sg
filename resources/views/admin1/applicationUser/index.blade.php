...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>user id</th>
                            ...
                            @foreach($applicationUser as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    ...
    <td>{!!  $row->user_id !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['applicationuser.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('applicationuser.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('applicationuser.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
