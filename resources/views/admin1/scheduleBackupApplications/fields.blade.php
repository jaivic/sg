...
<section>
    ...
    {!! Form::label('instancia_id', 'instanciaId:',['class' => 'label']) !!}
    <label class="input">
         {!! Form::text('instancia_id', null, ['class' => 'input-xs']) !!}
    </label>
</section><section>
...
<footer> 
    ...
    <a href="{!! route('schedulebackupapplications.index') !!}" class="btn btn-default">Cancel</a>
</footer>