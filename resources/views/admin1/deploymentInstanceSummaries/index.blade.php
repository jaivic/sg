...
@section('content')
   <section id="widget-grid" class="">
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            <thead>			                
                                <tr>
                                 <th>id</th>
    <th>deployment information id</th>
    <th>instance id</th>
    <th>status</th>
    <th>created at</th>
    <th>updated at</th>
                            ...
                            @foreach($deploymentInstanceSummaries as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->deployment_information_id !!}</td>
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['deploymentinstancesummaries.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('deploymentinstancesummaries.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('deploymentinstancesummaries.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
