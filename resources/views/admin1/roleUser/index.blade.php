...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->role_id !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['roleuser.delete',$row->user_id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('roleuser.show', [$row->user_id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('roleuser.edit', [$row->user_id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
