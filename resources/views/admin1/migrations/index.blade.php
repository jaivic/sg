...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->batch !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['migrations.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('migrations.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('migrations.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
