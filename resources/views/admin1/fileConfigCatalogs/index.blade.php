...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>deleted at</th>
                            ...
                            @foreach($fileConfigCatalogs as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    ...
    <td>{!!  $row->deleted_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['fileconfigcatalogs.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('fileconfigcatalogs.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('fileconfigcatalogs.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
