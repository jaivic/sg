...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['permissions.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('permissions.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('permissions.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
