...
<section>
    ...
    {!! Form::label('backup_application_id', 'backupApplicationId:',['class' => 'label']) !!}
    <label class="input">
         {!! Form::text('backup_application_id', null, ['class' => 'input-xs']) !!}
    </label>
</section><section>
    {!! Form::label('folder_name', 'folderName:',['class' => 'label']) !!}
    <label class="input">
         {!! Form::text('folder_name', null, ['class' => 'input-xs']) !!}
    </label>
</section><section>
...
<footer> 
    ...
    <a href="{!! route('backupdetailapplications.index') !!}" class="btn btn-default">Cancel</a>
</footer>