...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->relanzar !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['backups.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('backups.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('backups.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
