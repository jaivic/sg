...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->role_id !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['permissionrole.delete',$row->permission_id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('permissionrole.show', [$row->permission_id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('permissionrole.edit', [$row->permission_id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
