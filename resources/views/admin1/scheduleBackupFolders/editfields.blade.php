...
<section>
    ...
    {!! Form::label('backups_aplicacion_id', 'backupsAplicacionId:',['class' => 'label']) !!}
    <label class="input">
         {!! Form::text('backups_aplicacion_id', null, ['class' => 'input-xs']) !!}
    </label>
</section><section>
...
<footer> 
    ...
    <a href="{!! route('schedulebackupfolders.index') !!}" class="btn btn-default">Cancel</a>
</footer>