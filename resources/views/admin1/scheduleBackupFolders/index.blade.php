...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>updated at</th>
                            ...
                            @foreach($scheduleBackupFolders as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    <td>{!!  $row->backups_aplicacion_id !!}</td>
    <td>{!!  $row->name !!}</td>
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['schedulebackupfolders.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('schedulebackupfolders.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('schedulebackupfolders.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
