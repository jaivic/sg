...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>is ansible</th>
    <th>domain</th>
    <th>mirror instance</th>
    <th>mirror instance id</th>
    <th>forward time</th>
    <th>created at</th>
    <th>updated at</th>
                            ...
                            @foreach($scheduleBackups as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    ...
    <td>{!!  $row->domain !!}</td>
    <td>{!!  $row->mirror_instance !!}</td>
    <td>{!!  $row->mirror_instance_id !!}</td>
    <td>{!!  $row->forward_time !!}</td>
    <td>{!!  $row->created_at !!}</td>
    <td>{!!  $row->updated_at !!}</td>
    
                                    <td>   
                                        {!! Form::open(['route' => ['schedulebackups.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('schedulebackups.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('schedulebackups.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
