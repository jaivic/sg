...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->deleted_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['environments.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('environments.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('environments.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
