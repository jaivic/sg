...
@section('content')
   <section id="widget-grid" class="">
    ...
    <th>updated at</th>
                            ...
                            @foreach($mailingListTicket as $row)
                                <tr>
                                    <td>{!!  $row->id !!}</td>
    ...
    <td>{!!  $row->updated_at !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['mailinglistticket.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('mailinglistticket.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('mailinglistticket.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
