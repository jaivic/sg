...
@section('content')
   <section id="widget-grid" class="">
    ...
    <td>{!!  $row->emergency_level !!}</td>
                                    ...
                                    <td>   
                                        {!! Form::open(['route' => ['tickets.delete',$row->id], 'method' => 'delete']) !!}
                                        <div class='btn-group'>
                                            <a href="{!! route('tickets.show', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                                            <a href="{!! route('tickets.edit', [$row->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
